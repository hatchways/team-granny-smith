...
const { scrapingAmazon, scrapingEbay } = require("./urlScraping");
...
async function setScraperInterval(cron) {
  schedule.scheduleJob(cron, async () => {
    ...
    for (
      ...
      if (doc.url.includes("www.ebay.")) {
        await scrapingEbay(doc.url).then(function (updated) {
          if (updated != null) {
      ...
      } else if (doc.url.includes("www.amazon.")) {
